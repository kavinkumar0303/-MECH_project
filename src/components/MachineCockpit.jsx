        ...
        {Object.values(MACHINES).map((m) => (
          <button
            ...
            style={{
              padding: '8px 16px',
              borderRadius: '4px',
              border: '1px solid ' + (selectedId === m.id ? 'var(--brand-primary)' : 'rgba(10, 92, 255, 0.15)'),
              background: selectedId === m.id ? 'rgba(10, 92, 255, 0.15)' : 'transparent',
          ...
          return (
            <button
              ...
              style={{
                ...
                padding: '6px 14px',
                borderRadius: '20px',
                border: '1px solid ' + (isActive ? 'var(--brand-primary)' : 'rgba(10, 92, 255, 0.15)'),
                background: isActive ? 'var(--brand-primary)' : 'rgba(248, 250, 252, 0.8)',
              ...
              onMouseLeave={(e) => {
                if (!isActive) {
                  e.currentTarget.style.borderColor = 'rgba(10, 92, 255, 0.15)';
        ...
        >
          {activeSubTab === 'operate' ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              {/* Power Toggle */}
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'rgba(248, 250, 252, 0.9)', border: '1px solid rgba(10, 92, 255, 0.2)', padding: '12px', borderRadius: '6px' }}>
              ...
              {/* Speed range */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', background: 'rgba(248, 250, 252, 0.9)', border: '1px solid rgba(10, 92, 255, 0.2)', padding: '12px', borderRadius: '6px' }}>
            ...
            <>
              ...
              {activeSubTab === 'identify' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  {identifyTargetPart && (
                    <div style={{ padding: '12px', background: 'rgba(255, 255, 255, 0.9)', border: '1px solid var(--border)', borderRadius: '4px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    {Object.keys(safetyItems).map((key) => (
                      <button
                        ...
                        style={{
                          padding: '10px 14px',
                          background: safetyItems[key] ? 'rgba(10, 92, 255, 0.08)' : 'transparent',
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <button
                      ...
                      style={{
                        padding: '10px 12px',
                        background: setupChecklist.stockSecured ? 'rgba(10, 92, 255, 0.08)' : 'transparent',
                    ...
                    <button
                      ...
                      style={{
                        padding: '10px 12px',
                        background: setupChecklist.toolClamped ? 'rgba(10, 92, 255, 0.08)' : 'transparent',
                    ...
                    <button
                      ...
                      style={{
                        padding: '10px 12px',
                        background: setupChecklist.safetyGuardAligned ? 'rgba(10, 92, 255, 0.08)' : 'transparent',
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '8px' }}>
                    {machine.troubleshoot[troubleIdx].options.map(opt => (
                      <button 
                        ...
                        style={{ 
                          padding: '10px 12px', 
                          background: selectedOptionId === opt.id ? 'rgba(10,92,255,0.08)' : 'transparent', 
            ...
            >
              ...
              >
                ...
                <div style={{ height: '35px', width: '100%', marginTop: '6px', overflow: 'hidden' }}>
                  <svg width="100%" height="35" style={{ background: 'rgba(255, 255, 255, 0.95)', borderRadius: '4px' }}>
                    <path 
              ...
              >
                ...
                <div 
                  style={{ 
                    flex: 1, 
                    background: 'radial-gradient(circle, #0A5CFF 0%, #F8FAFC 100%)', 
                    borderRadius: '4px',
                    position: 'relative',
                    border: '1px solid rgba(10, 92, 255, 0.25)',
                    display: 'flex',
              ...
              <div style={{ display: 'flex', gap: '8px', borderBottom: '1px solid var(--border)', paddingBottom: '8px' }}>
                <button
                  ...
                  style={{
                    ...
                    background: practiceMode ? 'rgba(10, 92, 255, 0.1)' : 'transparent',
                  ...
                  {machine.operations.map((op, idx) => {
                    ...
                    return (
                      <button
                        ...
                        style={{
                          padding: '6px 10px',
                          background: isFocused ? 'rgba(10, 92, 255, 0.15)' : isCompleted ? 'rgba(82, 183, 136, 0.08)' : 'rgba(255,255,255,0.02)',
          ...
          >
            <div style={{ display: 'flex', gap: '8px', pointerEvents: 'auto' }}>
              <button
                ...
                style={{
                  background: isExploded ? 'rgba(10, 92, 255, 0.15)' : 'rgba(241, 245, 249, 0.9)',
              ...
              <button
                ...
                style={{
                  background: isCutaway ? 'rgba(10, 92, 255, 0.15)' : 'rgba(241, 245, 249, 0.9)',
            ...
            <div style={{ display: 'flex', gap: '6px', pointerEvents: 'auto' }}>
              {[
                ...
                <button
                  ...
                  style={{
                    background: cameraMode === cam.id ? 'rgba(10, 92, 255, 0.15)' : 'rgba(241, 245, 249, 0.9)',
          ...
          {activeSubTab === 'operate' ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', height: '100%' }}>
              ...
              <div 
                style={{ 
                  display: 'flex', 
                  borderBottom: '1px solid rgba(10, 92, 255, 0.25)', 
                  paddingBottom: '4px',
                  gap: '8px'
                }}
              >
              ...
              <div style={{ flex: 1, overflowY: 'auto', paddingRight: '4px' }}>
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            gap: '12px',
                            padding: '12px',
                            background: isSelected ? 'rgba(10, 92, 255, 0.08)' : 'rgba(241, 245, 249, 0.9)',
                            border: '1px solid ' + (isSelected ? 'var(--brand-primary)' : 'rgba(10, 92, 255, 0.15)'),
                            borderRadius: '6px',
                            cursor: 'pointer',
                            transition: 'all 0.2s'
                          }}
                ...
                {activeRightTab === 'measurement' && (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    <div style={{ background: 'rgba(255, 255, 255, 0.9)', border: '1px solid rgba(10, 92, 255, 0.25)', padding: '16px', borderRadius: '6px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px' }}>
            ...
            <>
              {activeSubTab === 'explorer' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  {activePart && (
                    <div style={{ borderLeft: `3px solid var(--brand-primary)`, paddingLeft: '12px', background: 'rgba(241, 245, 249, 0.8)', padding: '16px', borderRadius: '4px' }}>
              ...
              {activeSubTab === 'setup' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  {setupPassed ? (
                    ...
                    <div style={{ padding: '12px', background: 'rgba(241, 245, 249, 0.8)', border: '1px solid var(--border)', borderRadius: '4px', fontSize: '11px', color: 'var(--text-secondary)' }}>
              ...
              {activeSubTab === 'scorecard' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', background: 'rgba(255, 255, 255, 0.9)', border: '1px solid rgba(10, 92, 255, 0.25)', padding: '16px', borderRadius: '6px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '11.5px' }}>
